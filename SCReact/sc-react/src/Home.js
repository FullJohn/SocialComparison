...
export class Home extends Component{
    ...
    constructor(props) {
        ...
        this.state = {platform: 'YouTube', brand1: '', brand2: '', brand3: '', startDate: new Date(), endDate: new Date(), redirect: false};
    ...
    render(){
        ...
        return(
            <form onSubmit={this.handleSubmit}>
                ...
                <button type="submit" name="redirect" value={this.state.redirect} onClick={this.handleChange}>
                    Submit
                </button>
